...
interface Api {
    ...
    fun newBookingRequest(@Field("user_id") user_id: String,
                          ...
                          @Field("picklaterdate") picklaterdate: String,): Call<ResponseBody>
    ...
    fun getEstimateAmount(
                          ...
                          @Field("pickuplon") pickuplon: String,
                          @Field("droplat") droplat: String,
                          @Field("droplon") droplon: String): Call<ResponseBody>

    @FormUrlEncoded
    @POST("get_booking_history")
    fun getHistoryTaxiBooking(@Field("user_id") user_id: String,
                              @Field("type") type: String): Call<ResponseBody>
    @FormUrlEncoded
    @POST("get_booking_details")
    fun get_booking_details(@Field("request_id") request_id: String,
                            @Field("type") type: String): Call<ResponseBody>


    @FormUrlEncoded
    @POST("get_current_booking")
    fun getCurrentTaxiBooking(@Field("user_id") user_id: String,
                              @Field("type") type: String): Call<ResponseBody>


    @FormUrlEncoded
    @POST("driver_accept_and_Cancel_request")
    fun acceptCancelOrderCallTaxi(@Field("status") status: String,
                                  @Field("request_id") request_id: String,
                                  @Field("driver_id") driver_id: String,
                                  @Field("timezone") timezone: String): Call<ResponseBody>
